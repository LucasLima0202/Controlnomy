...
`;
// Componente Button
const Button = ({ title, onPress, color, children, bgcolor, fontsize, }) => {
    return (_jsxs(StyledButton, { bgcolor: bgcolor, onClick: onPress, color: color, fontsize: fontsize, children: [title, children] }));
};
