...
import { Dateinfo, Column, Row, Septext, SepPrice, SepIcon, Price, Icon, Container, GroupLine, GroupWelcome, TitleFormat, } from "./ListLimit.styled";
...
const ListLimit = () => {
    ...
    return (_jsx(GroupWelcome, { children: _jsx(GroupLine, { children: _jsx(Container, { id: "list", children: transactions.map((transaction) => {
